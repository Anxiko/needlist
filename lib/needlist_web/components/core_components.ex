...
defmodule NeedlistWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 text-white active:text-white/80 disabled:cursor-not-allowed",
        @class
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeedlistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeedlistWeb.Gettext, "errors", msg, opts)
    end
  end
