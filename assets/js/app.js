...
import { Countdown } from '../vendor/countdown/hook';
...
let liveSocket = new LiveSocket("/live", Socket, { params: { _csrf_token: csrfToken, time_zone: Intl.DateTimeFormat().resolvedOptions().timeZone }, hooks: Hooks })
