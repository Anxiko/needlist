defmodule NeedlistWeb.AccountLoginLiveTest do
  ...
  describe "account login" do
    test "redirects if account login with valid credentials", %{conn: conn} do
    ...
    test "redirects to login page with a flash error if there are no valid credentials", %{
      ...
      form =
        form(lv, "#login_form", account: %{email: "test@email.com", password: "123456", remember_me: true})
